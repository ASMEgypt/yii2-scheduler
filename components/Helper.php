...
class Helper extends \DHTMLX_Scheduler\Helper
{
    private $dsn = null;
    ...
    public function getConnection()
    {
        ...
        if ($this->dsn === null) {
            $dsl = $this->getConfigStringPDO();
        } else {
            $dsl = $this->dsn;
        }

        $this->_PDO = ($this->_PDO) ? $this->_PDO : new \PDO($dsl, $this->_user, $this->_password, $PDO_options);
        return $this->_PDO;
    }
